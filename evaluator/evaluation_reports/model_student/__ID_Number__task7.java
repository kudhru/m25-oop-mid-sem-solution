...
public class RoomsService {
  ...
  public static void main(String[] args) {
    ...
    List<Room> filtered7_1 = service.filterRooms(150, Building.LTC, false, false);
    List<Room> filtered7_1_1 = service.filterRooms(150, Building.NAB, false, false);
    List<Room> filtered7_1_2 = service.filterRooms(150, Building.FD1, false, false);
    List<Room> filtered7_1_3 = service.filterRooms(150, Building.FD2, false, false);
    List<Room> filtered7_1_4 = service.filterRooms(150, Building.FD3, false, false);
    int k = filtered7_1.size()+filtered7_1_1.size()+filtered7_1_2.size()+filtered7_1_3.size()+filtered7_1_4.size();
    System.out.println("Actual: " + k + " rooms");
    System.out.println("Result: " + (k >= 2 ? "PASS" : "FAIL"));
    System.out.println();
    ...
    List<Room> filtered7_2 = service.filterRooms(50, Building.LTC, false, false);
    ...
    List<Room> filtered7_3 = service.filterRooms(50, Building.NAB, true, false);
    List<Room> filtered7_3_1 = service.filterRooms(50, Building.LTC, true, false);
    List<Room> filtered7_3_2 = service.filterRooms(50, Building.FD1, true, false);
    List<Room> filtered7_3_3 = service.filterRooms(50, Building.FD2, true, false);
    List<Room> filtered7_3_4 = service.filterRooms(50, Building.FD3, true, false);
    k = filtered7_3.size()+filtered7_3_1.size()+filtered7_3_2.size()+filtered7_3_3.size()+filtered7_3_4.size();
    System.out.println("Actual: " + k + " rooms with projector");
    System.out.println("Result: " + (k >= 3 ? "PASS" : "FAIL"));
    System.out.println();
    ...
    List<Room> filtered7_4 = service.filterRooms(50, Building.NAB, false, true);
    List<Room> filtered7_4_1 = service.filterRooms(50, Building.LTC, false, true);
    List<Room> filtered7_4_2 = service.filterRooms(50, Building.FD1, false, true);
    List<Room> filtered7_4_3 = service.filterRooms(50, Building.FD2, false, true);
    List<Room> filtered7_4_4 = service.filterRooms(50, Building.FD3, false, true);
    k = filtered7_4.size()+filtered7_4_1.size()+filtered7_4_2.size()+filtered7_4_3.size()+filtered7_4_4.size();
    System.out.println("Actual: " + k + " rooms with internet");
    System.out.println("Result: " + (k >= 3 ? "PASS" : "FAIL"));
    System.out.println();
